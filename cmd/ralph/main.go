...
func parseFlags() config {
	...
	flag.StringVar(&cfg.planPath, "plan", "docs/milestones/v1-milestone-9-plan.md", "path to the milestone plan")
	flag.StringVar(&cfg.branch, "branch", "phase9", "implementation branch")
	flag.StringVar(&cfg.milestone, "milestone", "9", "human milestone label for completion/error messages")
