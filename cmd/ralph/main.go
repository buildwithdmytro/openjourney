...
func parseFlags() config {
	...
	flag.StringVar(&cfg.planPath, "plan", "docs/milestones/v1-milestone-14-plan.md", "path to the milestone plan")
	flag.StringVar(&cfg.branch, "branch", "phase14", "implementation branch")
	flag.StringVar(&cfg.milestone, "milestone", "14", "human milestone label for completion/error messages")
