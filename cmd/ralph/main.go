...
func parseFlags() config {
	...
	flag.StringVar(&cfg.planPath, "plan", "docs/milestones/v1-milestone-8-plan.md", "path to the milestone plan")
	flag.StringVar(&cfg.branch, "branch", "phase8", "implementation branch")
	flag.StringVar(&cfg.milestone, "milestone", "8", "human milestone label for completion/error messages")
