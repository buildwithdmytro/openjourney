...
func parseFlags() config {
	...
	flag.StringVar(&cfg.planPath, "plan", "docs/milestones/v1-milestone-19-plan.md", "path to the milestone plan")
	flag.StringVar(&cfg.branch, "branch", "phase19", "implementation branch")
	flag.StringVar(&cfg.milestone, "milestone", "19", "human milestone label for completion/error messages")
	...
	flag.StringVar(&cfg.antigravityModel, "antigravity-model", "gemini-3.6-flash-medium", "Antigravity model slug (see `agy models`)")
