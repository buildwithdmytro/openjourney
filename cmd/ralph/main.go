...
func parseFlags() config {
	...
	flag.StringVar(&cfg.planPath, "plan", "docs/milestones/v1-milestone-18-plan.md", "path to the milestone plan")
	flag.StringVar(&cfg.branch, "branch", "phase18", "implementation branch")
	flag.StringVar(&cfg.milestone, "milestone", "18", "human milestone label for completion/error messages")
