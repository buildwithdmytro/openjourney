...
func parseFlags() config {
	...
	flag.StringVar(&cfg.planPath, "plan", "docs/milestones/v1-milestone-12-plan.md", "path to the milestone plan")
	flag.StringVar(&cfg.branch, "branch", "phase12", "implementation branch")
	flag.StringVar(&cfg.milestone, "milestone", "12", "human milestone label for completion/error messages")
