...
func parseFlags() config {
	...
	flag.StringVar(&cfg.planPath, "plan", "docs/milestones/v1-milestone-13-plan.md", "path to the milestone plan")
	flag.StringVar(&cfg.branch, "branch", "phase13", "implementation branch")
	flag.StringVar(&cfg.milestone, "milestone", "13", "human milestone label for completion/error messages")
