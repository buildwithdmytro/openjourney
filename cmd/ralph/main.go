...
func parseFlags() config {
	...
	flag.StringVar(&cfg.planPath, "plan", "docs/milestones/v1-milestone-15-plan.md", "path to the milestone plan")
	flag.StringVar(&cfg.branch, "branch", "phase15", "implementation branch")
	flag.StringVar(&cfg.milestone, "milestone", "15", "human milestone label for completion/error messages")
